...
local Window = Library.CreateLib("Blade Ball", "GrapeTheme")
local workspace = game:GetService("Workspace")
local players = game:GetService("Players")
local runService = game:GetService("RunService")
local vim = game:GetService("VirtualInputManager")
local Stuff = Window:NewTab("Stuff")
local AutoThings = Stuff:NewSection("Auto Things")
...
local AutoParryToggle = AutoThings:NewToggle("ToggleText", "ToggleInfo", function(state)
    if state then
        runService.Heartbeat:Connect(checkBallsProximity)
    else
        AutoParryToggle:Disconnect()
    end
end)
AutoParryToggle.Parent = AutoThings